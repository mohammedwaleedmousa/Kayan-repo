...
(function () {
  ...
  var TIERS = {
    T0: {
      ...
      face: 'linear-gradient(168deg,#F0E8D2,#D8CDA9)', rail: '#C7BA92', grain: 26,
      weave: 'repeating-linear-gradient(112deg,rgba(255,255,255,.24) 0 1px,transparent 1px 5px)',
      grainInk: 'rgba(62,52,25,.24)', word: '#3E3620', meta: '#4F452A', tag: '#5C5133',
      lift: '0 1px 0 rgba(255,255,255,.55)', logo: LOGO_DARK, logoOpacity: '.88',
      back: '#3E3620', accent: '#D8CDA9', backInk: '#F4EEDC', backMute: 'rgba(244,238,220,.72)',
      barTrack: 'rgba(244,238,220,.22)', shadow: '0 20px 50px rgba(62,52,25,.16)',
      deliveries: 0, bar: 0
    },
    T1: {
      ar: 'معرف', en: 'Identified', stamp: 'RECORD · OPENED',
      face: 'linear-gradient(168deg,#E8D6A4,#C5A758)', rail: '#BFA24C', grain: 19,
      weave: 'repeating-linear-gradient(112deg,rgba(255,255,255,.20) 0 1px,transparent 1px 5px)',
      grainInk: 'rgba(59,47,6,.22)', word: '#3E3308', meta: '#4E400C', tag: '#5D4D10',
      lift: '0 1px 0 rgba(255,255,255,.45)', logo: LOGO_DARK, logoOpacity: '1',
      back: '#3E3308', accent: '#C5A758', backInk: '#FBF3DC', backMute: 'rgba(251,243,220,.74)',
      barTrack: 'rgba(251,243,220,.2)', shadow: '0 20px 52px rgba(191,162,76,.30)',
      deliveries: 2, bar: 8
    },
    T2: {
      ar: 'موثق', en: 'Verified', stamp: 'RECORD · VERIFIED',
      face: 'linear-gradient(158deg,#F3DE9C 0%,#D4AF37 48%,#A8861C 100%)', rail: '#D4AF37', grain: 13,
      weave: 'repeating-linear-gradient(112deg,rgba(255,255,255,.26) 0 1px,transparent 1px 5px)',
      grainInk: 'rgba(59,47,6,.24)', word: '#3B2F06', meta: '#4A3B08', tag: '#5A480C',
      lift: '0 1px 0 rgba(255,255,255,.38)', logo: LOGO_DARK, logoOpacity: '1',
      back: '#3B2F06', accent: '#D4AF37', backInk: '#FBF0D2', backMute: 'rgba(251,240,210,.75)',
      barTrack: 'rgba(251,240,210,.2)', shadow: '0 22px 56px rgba(212,175,55,.34)',
      deliveries: 6, bar: 23, tagWeight: '600'
    },
    T3: {
      ar: 'مثبت', en: 'Established', stamp: 'RECORD · PROVEN',
      face: 'linear-gradient(158deg,#E2B93F 0%,#B8901C 46%,#7E6410 100%)', rail: '#C9A227', grain: 9,
    ...
    T4: {
      ar: 'مؤتمن', en: 'Entrusted', stamp: 'RECORD · TRUSTED',
      face: 'linear-gradient(168deg,#4A3A0C 0%,#2A2006 58%,#140F02 100%)',
      rail: 'linear-gradient(180deg,#F3DE9C,#C9A227)', grain: 6,
      ...
      back: '#140F02', accent: '#E9BE4B', backInk: '#FAF6EC', backMute: 'rgba(250,246,236,.72)',
